...
directory = '/media/Programming/GitHub/MW/database/flags/'
...
for filename in os.listdir(directory):
    ...
    # Convert the country code to lowercase and check if it exists in the map
    if country_code in country_map:
        # Get the corresponding country name
        country_name = country_map[country_code]
        
        # Construct the new filename
        new_filename = f"{country_name}.png"
